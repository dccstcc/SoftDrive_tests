...
//   private TrafficView view; // view containing the Cannon
//
//   // constructor
//   public Cannon(TrafficView view, int baseRadius, int barrelLength,
//      int barrelWidth) {
//      this.view = view;
